Public Class FormTambahDataMerek3

    Private Sub FormTambahDataMerek3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        autokode()
        tbnamamerek.Focus()
        tbnamamerek.Text = ""
    End Sub
    ...
    Private Sub FormTambahDataMerek2_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
