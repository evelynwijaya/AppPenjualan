...
Public Class LaporanKategori
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppPenjualan.LaporanKategori.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanKategori
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanKategori = New LaporanKategori()
        rpt.Site = Me.Site
        Return rpt
    End Function
